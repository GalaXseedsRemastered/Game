...
/// Class:   Ad
/// Version: 0.1 
/// Contact: Dan Vogler, Jeff Lauglin
/// Site: Galaxseeds
//////////////////////////////////////////////////////////
...
Ad.prototype = {
  ...
  write: function(size, tiles, direction, zone){
	...
	if (zone)    this.setAttribute('zone', zone);
    if (tiles) {
        if (direction) {str_tiles = "tn="+tiles+";to="+direction+";tbw=0;tp=1;tsw=0x0";}
        else           {str_tiles = "tn="+tiles+";to=v;tbw=0;tp=1;tsw=0x0";}
    }
    
    document.write('<SCR'+'IPT LANGUAGE="JavaScript1.1" SRC="http://127.0.0.1/adj/' + this.getAttribute("site") + '.site112.tmus/' + this.getAttribute("zone") + ';comp=' + adid +';genre=' + this.getAttribute("category") + ';page=' + window.location.pathname+ ';' + str_tiles + ';sz=' + size + ';ord=' + this.getAttribute("ord") + '?"><\/SCRIPT>');
    if ((!document.images && navigator.userAgent.indexOf("Mozilla/2.") >= 0)  || navigator.userAgent.indexOf("WebTV")>= 0) {
        document.write('<A HREF="http://127.0.0.1/jump/' + this.getAttribute("site") + '.site112.tmus/' + this.getAttribute("zone") +';comp=' + adid +';genre=' + this.getAttribute("category") + ';tile=' + tile + ';sz=' + size + ';ord=' + this.getAttribute("ord") + '?" TARGET="_blank">');
        document.write('<IMG SRC="http://127.0.0.1/ad/' + this.getAttribute("site") + '.site112.tmus/' + this.getAttribute("zone") +  ';comp=' + adid +';genre=' + this.getAttribute("category") + ';tile='+tile+';sz=' + size + ';ord=' + this.getAttribute("ord") + '?" BORDER="0" ALT=""></A>');
    }
  }
}
...
path_mapping["gameguide"]   = "gameguide";
path_mapping["help"]        = "help";
path_mapping["parents"]     = "parents";
path_mapping["play"]		= "play";
path_mapping["whatsnew"]    = "whatsnew";
